 ...
 * Generated at: 2018-11-20 12:08:05 UTC
...
public final class AddUserPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"AddNewUserPage.jsp\">Add New\r\n");
      out.write("\t\t\t\t\t\t\t\tUser</a></li>\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t<form id=\"addNewUserForm\" method=\"post\"\r\n");
      out.write("\t\t\t\t\t\t\taction=\"/Lunchy/AddUserServlet\">\r\n");
      out.write("\t\t\t\t\t\t\t<div style=\"float: left;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<span><label>Select Account Type</label></span> <select\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"accountType\" style=\"float: left;\" id=\"soflow\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option>Adminitrator</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option>Restaurant Employee</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option>Client</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span><label>Username</label></span> <span><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"userName\" type=\"text\" class=\"textbox\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span><label>First Name</label></span> <span><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"firstName\" type=\"text\" class=\"textbox\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span><label>Last Name</label></span> <span><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"lastName\" type=\"text\" class=\"textbox\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span><label>Initial Password</label></span> <span><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"password\" type=\"text\" class=\"textbox\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<br></br>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span><input type=\"submit\" class=\"mybutton\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"Add User\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\tdocument.getElementById(\"addNewUserForm\").reset();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t</script>\r\n");
